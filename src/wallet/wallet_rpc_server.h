  ...
  private:
    ...
    BEGIN_URI_MAP2()
      BEGIN_JSON_RPC_MAP("/json_rpc")
        ...
        MAP_JON_RPC_WE("send_payment", on_send_payment, wallet_rpc::COMMAND_RPC_SEND_PAYMENT)
    ...
    END_URI_MAP2()
      ...
      bool on_send_payment(const wallet_rpc::COMMAND_RPC_SEND_PAYMENT::request& req, wallet_rpc::COMMAND_RPC_SEND_PAYMENT::response& res, epee::json_rpc::error& er, connection_context& cntx);
