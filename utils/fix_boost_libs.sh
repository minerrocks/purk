...
{
  install_name_tool -change libboost_system.dylib          $1/libboost_system.dylib          $2/libboost_thread-mt.dylib
  install_name_tool -change libboost_system.dylib          $1/libboost_system.dylib          $2/libboost_filesystem.dylib
  install_name_tool -change libboost_system.dylib          $1/libboost_system.dylib          $2/libboost_locale-mt.dylib
...
function update_links_in_boost_binary() # $1 - path to boost libs, $2 - binary to update
{
  ...
  install_name_tool -change libboost_thread-mt.dylib        $1/libboost_thread.dylib           $2
  install_name_tool -change libboost_serialization.dylib    $1/libboost_serialization.dylib    $2
  install_name_tool -change libboost_locale-mt.dylib        $1/libboost_locale-mt.dylib           $2
  return 0
}
